...
public class PixApproveDeposit {
    private final WebDriver driver;
    public steps.Login Login;
    private FundHistoryPage FundHistoryPage;
    private NavigationPage NavigationPage;

    public PixApproveDeposit(Driver driver) {
    ...
    public void iGetDetails(DataTable brUserFund){
        ...
        String transId = details.get(1).get(0); //FundHistoryPage.getFirstRowTransId();  //;
    ...
    public void iGetAgentProductDetails(){
        ...
        String wwwl_url = steps.Login.www_url;

        try {
            //check report_casino if null stage_b2c
            String query = " SELECT deposit_rollover_multiplier FROM `b2c`.`agent_products` " +
            ...
            ResultSet ap = DatabaseConnection.execProdBrasilQuery(query);
    ...
    String depositAmount = Deposit.depositAmount;
    String balanceBeforeDeposit = Deposit.balanceBefore;
    String rolloverBeforeDeposit = Deposit.rolloverBefore;
    ...
    public void checkTheBalance(){
        ...
        balanceAfterDeposit = FundHistoryPage.getBalance();
        rolloverAfterDeposit = FundHistoryPage.getRollover();
        ...
        if(expectedBalanceAfterDeposit.equals(balanceAfter)  && (expectedRolloverAfterDeposit.equals(rolloverAfter))){
            ...
            System.out.println("DepositPage amount: " + depositAmount +
            ...
            System.out.println("Either the balance or the rollover is not tally."+
                    "\nDepositPage amount: " + depositAmount +
                    "\nBalance before:" + balanceBeforeDeposit +
                    "\nBalance after: " + balanceAfterDeposit +
