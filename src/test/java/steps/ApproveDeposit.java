...
public class ApproveDeposit {
    ...
    public void iGetTheGeneratedToken() {
        ...
        WebElement text = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//div[contains(concat(' ',@class,' '), ' box-content ')]//div[contains(concat(' ',@class,' '), ' CodeMirror-code ')]")));
